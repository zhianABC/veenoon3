...
#import "AddWetRightView.h"

@interface EngineerAddWetViewCtrl () <CustomPickerViewDelegate>{
...
@implementation EngineerAddWetViewCtrl
@synthesize _addWetSysArray;
@synthesize _number;
- (void)viewDidLoad {
    ...
    [_selectSysBtn setTitle:@"加湿 " forState:UIControlStateNormal];
...
- (void) didConfirmPickerValue:(NSString*) pickerValue {
    ...
    NSString *title =  [@"加湿 " stringByAppendingString:pickerValue];
