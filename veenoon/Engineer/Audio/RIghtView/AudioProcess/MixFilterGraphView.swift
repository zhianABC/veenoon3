...
class MixFilterGraphView: UIView {
    ...
    private let movePointHilightFillColor = UIColor(red: 255/255.0, green: 180/255.0, blue: 0/255.0, alpha: 1.0)
...
//        }
    ...
    private func paintMovePoint() {
        ...
        for i in 0 ..< m_peqBand+2 {
            ...
            if(bPressed[i])
            {
                context?.setFillColor(movePointHilightFillColor.cgColor)
            }
            else
            {
                context?.setFillColor(movePointFillColor.cgColor)
