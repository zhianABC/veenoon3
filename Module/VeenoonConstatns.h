...
// 视频 - 视频播放器
extern NSString *const VideoDVDPlayerName;
extern NSString *const VideoDVDPlayerCom;
extern NSString *const VideoDVDPlayerIP;
extern NSString *const VideoDVDPlayerAction;
extern NSString *const VideoDVDPlayerPowerStatus;
